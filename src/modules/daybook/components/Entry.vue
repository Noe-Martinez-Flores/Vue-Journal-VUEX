...
<template>
  <div class="entry-container mb-3 pointer p-2"
   @click="$router.push({ name : 'entry-enter', params : { id : 10 } })">
    ...
    <div class="entry-description">
      ...
      omnis, numquam veniam eaque tempora qui possimus dignissimos quis
      laboriosam, accusamus autem. Eaque perspiciatis atque aspernatur eos
      aliquid enim tempora?
    </div>
  </div>
</template>
